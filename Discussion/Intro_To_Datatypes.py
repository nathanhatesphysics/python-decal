...
variable4 = g  # Data type of variable4: string?
...
# Normal Division: Divides either floats or ints, always returns a float
# Floor Division: Divides two ints or floats, always rounds down, always returns an int
# Modulo Division: Divides two numbers and returns the remainder, always returns an int
